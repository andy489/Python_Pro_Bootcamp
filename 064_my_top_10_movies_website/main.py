...
# https://www.imdb.com/list/ls058705802/

# https://starsgroup.udemy.com/course/100-days-of-code/learn/lecture/22595040#overview
...
class RateMovieForm(FlaskForm):
    rating = FloatField(label="Your Rating Out of 10 e.g. 7.5",
                        validators=[DataRequired(), NumberRange(min=0.0, max=10.0,
                                                                message="Rating must be a float number between 0.0 and 10.0")])
...
def rate_movie():
    ...
    if form.validate_on_submit():
        movie.rating = round(float(form.rating.data), 1)
