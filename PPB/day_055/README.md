...
<div style="font-size: 1.2em">
    ...
    <ol>
        ...
        <li>
            ...
            <div>
                <br/>
                <img src="assets/01.png" alt="guess number" style="width: 420px;"/>
            </div>
        </li>
        <br/>
        <li>
        ...
        <li>
            ...
            <ul>
                <li>
                    3 is too low:
                    <div>
                        <img src="assets/02.png" alt="too low" style="width: 420px;"/>
                    </div>
                </li>
                <li>
                    8 is too high
                    <div>
                        <img src="assets/03.png" alt="too high" style="width: 420px;"/>
                    </div>
                </li>
                <li>
                    5 is right
                    <div>
                        <img src="assets/04.png" alt="right guess" style="width: 420px;"/>
                    </div>
                </li>
            </ul>
        </li>
