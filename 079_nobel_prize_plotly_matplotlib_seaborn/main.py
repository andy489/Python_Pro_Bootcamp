...
# print(df_data.sort_values("year").head())
# print(df_data.sort_values("year").tail())

# print(f'Any duplicates? {df_data.duplicated().values.any()}')
# print(f'Any NaN values among the data? {df_data.isna().values.any()}')
# print(df_data.isna().sum())
col_subset1 = ['year', 'category', 'laureate_type',
               'birth_date', 'full_name', 'organization_name']
# print(df_data.loc[df_data.birth_date.isna()][col_subset1])

col_subset2 = ['year', 'category', 'laureate_type', 'full_name', 'organization_name']
# print(df_data.loc[df_data.organization_name.isna()][col_subset2])
...
# palette = get_hex("Acadia", keep_first_n=6)
#
# plt.figure(figsize=(8, 4), dpi=200)
# with sns.axes_style("whitegrid"):
